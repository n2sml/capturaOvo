 ...
 * @author dexter
 */
public class testeBarra extends javax.swing.JFrame {

    /**
     * Creates new form testeBarra
     */
    public testeBarra() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testeBarra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testeBarra().setVisible(true);                
            }
        });
